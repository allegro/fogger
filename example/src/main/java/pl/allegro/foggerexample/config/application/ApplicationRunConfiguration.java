...
package pl.allegro.foggerexample.config.application;


import android.content.SharedPreferences;
import pl.allegro.foggerexample.content.SharedPreferencesAdapter;

public class ApplicationRunConfiguration {

    private final SharedPreferencesAdapter sharedPreferencesAdapter;

    private ApplicationRunConfiguration(SharedPreferencesAdapter sharedPreferencesAdapter) {
